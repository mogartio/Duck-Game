...
std::string wingState_to_string(WingState state) {
    switch (state) {
        case WingState::NORMAL:
            return "wing/normal.png";
        case WingState::HOLD:
            return "wing/hold.png";
        case WingState::FLAPUP:
            return "wing/flapUp.png";
        case WingState::FLAPDOWN:
            return "wing/flapDown.png";
        default:
            return "unknown.png";
    }
}
...
std::string helmet_to_string(ProjectilesId::ProjectileId helmet) {
    switch (helmet) {
        case ProjectilesId::ProjectileId::HELMET:
            return "normal.png";
        case ProjectilesId::ProjectileId::HELMET2:
            return "knight.png";
        case ProjectilesId::ProjectileId::HELMET3:
            return "tinfoil.png";
        default:
            return "unknown.png";
    }
