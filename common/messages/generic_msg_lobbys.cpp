...
void ExampleMsg::accept_send(Handler& protocol) { protocol.handle_send(*this); }

std::string ExampleMsg::getData() const { return data; }

ViewLobbiesMsg::ViewLobbiesMsg(): LobbyMsg(VIEW_LOBBIES) {}

void ViewLobbiesMsg::accept_send(Handler& protocol) { protocol.handle_send(*this); }

LobbyListMsg::LobbyListMsg(): LobbyMsg(LOBBY_LIST) {}

void LobbyListMsg::accept_send(Handler& protocol) { protocol.handle_send(*this); }

JoinedLobbyMsg::JoinedLobbyMsg(): LobbyMsg(JOINED_LOBBY) {}

void JoinedLobbyMsg::accept_send(Handler& protocol) { protocol.handle_send(*this); }

CreateLobbyMsg::CreateLobbyMsg(): LobbyMsg(CREATE_LOBBY) {}

void CreateLobbyMsg::accept_send(Handler& protocol) { protocol.handle_send(*this); }

ExitMsg::ExitMsg(): LobbyMsg(EXIT_FROM_LOBBY) {}

void ExitMsg::accept_send(Handler& protocol) { protocol.handle_send(*this); }

StartGameMsg::StartGameMsg(): LobbyMsg(START_GAME) {}

void StartGameMsg::accept_send(Handler& protocol) { protocol.handle_send(*this); }
