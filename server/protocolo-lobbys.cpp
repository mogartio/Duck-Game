...
ProtocoloLobbysServer::ProtocoloLobbysServer(Socket &socket, u_int8_t &idCliente) : ProtocoloCommon(socket), idCliente(idCliente) {}
...
ServerMensajeLobby ProtocoloLobbysServer::recvMensajeLobbys() {
    ...
    u_int8_t tipoMensaje = recv_u_int8_t();
